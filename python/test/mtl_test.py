...
def test_dispersive_connector_R_time():
    ...
    line = mtl.MTL(l=0.25e-6, c=100e-12, g=0.0, r=0.0, length=length, ndiv = 20,Zs=Zs, Zl=Zl)
...
def test_dispersive_connector_RCp_freq():
    ...
    poles = np.array([-1/(R*C)])    
    residues = np.array([1/(C*line.dz)])    
    D = 0
    E = 0
    line.connectors.add_dispersive_connector(
                                position = 250e-3, 
                                conductor=0,
                                d=D,
                                e=E,
...
def test_dispersive_connector_RLs_freq():
    ...
    D = R/line.dz # R pul
    E = L/line.dz # L pul
    line.connectors.add_dispersive_connector(position = 250e-3, 
                                conductor=0,
                                d=D,
                                e=E,
                                poles=poles, 
...
def test_generic_field():
    ...
    def ex(x,y,z,t): return -x+y+z+t
    def ey(x,y,z,t): return x-y+z+t
    def ez(x,y,z,t): return x+y-z+t
    ...
    eT = field.compute_eL_at_segment(u)
    print (eT(1,1,1,1))
